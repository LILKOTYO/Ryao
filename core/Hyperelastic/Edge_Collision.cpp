...
REAL Edge_Collision::psi(const VECTOR12 &x, const VECTOR2 &a, const VECTOR2 &b) const {
...
REAL Edge_Collision::psiNegated(const std::vector<VECTOR3> &v, 
                                const VECTOR2 &a, 
                                const VECTOR2 &b) const {
    return psiNegated(flattenVertices(v), a, b);
}

REAL Edge_Collision::psiNegated(const VECTOR12 &x, const VECTOR2 &a, const VECTOR2 &b) const {
    // convert to vertices and edges
    vector<VECTOR3> v;
    vector<VECTOR3> e;
    getVerticesAndEdges(x,v,e);
