...
REAL Vertex_Face_Collision::psi(const std::vector<VECTOR3> &v) const {
...
VECTOR12 Vertex_Face_Collision::gradient(const std::vector<VECTOR3> &v) const {
...
MATRIX12 Vertex_Face_Collision::hessian(const std::vector<VECTOR3> &v) const {
...
MATRIX12 Vertex_Face_Collision::clampedHessian(const std::vector<VECTOR3> &v) const {
