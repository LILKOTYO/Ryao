...
REAL Vertex_Face_Sqrt_Collision::psi(const std::vector<VECTOR3> &v) const {
...
VECTOR12 Vertex_Face_Sqrt_Collision::gradient(const std::vector<VECTOR3> &v) const {
    const VECTOR3 bary = getBarycentricCoordinates(v);
...
MATRIX12 Vertex_Face_Sqrt_Collision::hessian(const std::vector<VECTOR3> &v) const {
    const VECTOR3 bary = getBarycentricCoordinates(v);
...
MATRIX12 Vertex_Face_Sqrt_Collision::clampedHessian(const std::vector<VECTOR3> &v) const {
