...
/**
* @brief Eqn. 14 from Section 3.3 in "Stable Neo-Hookean Flesh Simulation"
*
* @param F
* @return REAL
*/
REAL SNHWithBarrier::psi(const MATRIX3 &F) const {
...
/**
* @brief Eqn. 18 from Section 4.2 in "Stable Neo-Hookean Flesh Simulation"
*
* @param F
* @return MATRIX3
*/
MATRIX3 SNHWithBarrier::PK1(const MATRIX3 &F) const {
    const REAL Ic = F.squaredNorm();
...
/**
* @brief Eqn. 41 from 4.6 in "Stable Neo-Hookean Flesh Simulation"
*
* @param F
* @return MATRIX9
*/
MATRIX9 SNHWithBarrier::hessian(const MATRIX3 &F) const {
...
/**
* @brief This is not what is actually what is used in production at Pixar.
...
* @return MATRIX9
*/
MATRIX9 SNHWithBarrier::clampedHessian(const MATRIX3 &U, const VECTOR3 &Sigma, const MATRIX3 &V) const {
    VECTOR9 eigenvalues;
...
bool SNHWithBarrier::energyNeedsSVD() const {
    return false;
}

bool SNHWithBarrier::PK1NeedsSVD() const {
    return false;
}
